...
const UpcomingCamps = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <p className="text-xl font-semibold text-center text-gray-400 mb-10">
        Discover the upcoming camps for Community Wellness
      </p>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {upcomingCamps.map((camp) => (
          <div key={camp._id} className="card bg-base-100 shadow-md border border-gray-200 hover:shadow-xl transition duration-300">
            <figure>
              <img
                src={camp.image}
                alt={camp.campName}
            ...
            <div className="card-body p-4">
              ...
              <p className="text-sm mt-2">
                ...
                {new Date(camp.date || camp.dateTime).toLocaleDateString()}
              </p>
              <p className="text-sm">
              ...
              <Link to={`/camp-details/${camp._id}`}>
                <button className="btn btn-sm btn-primary mt-3 w-full sm:w-auto">
                  View Details
                </button>
              </Link>
            </div>
