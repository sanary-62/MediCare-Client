...
//       <h2 className="text-3xl font-bold text-center mb-6 text-blue-700">Organizer Profile</h2>
...
//         className="btn btn-outline btn-info w-full py-2 font-semibold hover:bg-blue-700 hover:text-white transition duration-200 text-blue-600"
//       >
//         Update
//       </button>
